                ...
                connector
                    ...
                    .and_then(move |io| {
                        ...
                        Either::Left(Box::pin(async move {
                            ...
                            Ok(pool.pooled(connecting, PoolClient { conn_info: connected, tx, can_share }))
                        }))
                    }),
            )
        })
        ...
        match self.tx {
            ...
            PoolTx::Http2(tx) => {
                ...
                if self.can_share {
                    ...
                    let a = PoolClient { conn_info: self.conn_info, tx: PoolTx::Http2(tx), can_share: self.can_share };
