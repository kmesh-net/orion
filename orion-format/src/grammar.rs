...
static ENVOY_REQ_ARGS: LazyLock<Trie<u8, (Operator, Category, usize, bool)>> = LazyLock::new(|| {
...
static ENVOY_RESP_ARGS: LazyLock<Trie<u8, (Operator, Category, usize, bool)>> = LazyLock::new(Trie::new);
