...
bitflags! {
    ...
    pub struct ResponseFlags: u32 {
        const NO_HEALTHY_UPSTREAM                   = 0b000000000000000000000000000001;
        const UPSTREAM_CONNECTION_FAILURE           = 0b000000000000000000000000000010;
        const UPSTREAM_OVERFLOW                     = 0b000000000000000000000000000100;
        const NO_ROUTE_FOUND                        = 0b000000000000000000000000001000;
        const UPSTREAM_RETRY_LIMIT_EXCEEDED         = 0b000000000000000000000000010000;
        const NO_CLUSTER_FOUND                      = 0b000000000000000000000000100000;
        const DURATION_TIMEOUT                      = 0b000000000000000000000001000000;
        const DOWNSTREAM_CONNECTION_TERMINATION     = 0b000000000000000000000010000000;
        const FAILED_LOCAL_HEALTH_CHECK             = 0b000000000000000000000100000000;
        const UPSTREAM_REQUEST_TIMEOUT              = 0b000000000000000000001000000000;
        const LOCAL_RESET                           = 0b000000000000000000010000000000;
        const UPSTREAM_REMOTE_RESET                 = 0b000000000000000000100000000000;
        const UPSTREAM_CONNECTION_TERMINATION       = 0b000000000000000001000000000000;
        const DELAY_INJECTED                        = 0b000000000000000010000000000000;
        const FAULT_INJECTED                        = 0b000000000000000100000000000000;
        const RATE_LIMITED                          = 0b000000000000001000000000000000;
        const UNAUTHORIZED_EXTERNAL_SERVICE         = 0b000000000000010000000000000000;
        const RATE_LIMIT_SERVICE_ERROR              = 0b000000000000100000000000000000;
        const INVALID_ENVOY_REQUEST_HEADERS         = 0b000000000001000000000000000000;
        const STREAM_IDLE_TIMEOUT                   = 0b000000000010000000000000000000;
        const DOWNSTREAM_PROTOCOL_ERROR             = 0b000000000100000000000000000000;
        const UPSTREAM_PROTOCOL_ERROR               = 0b000000001000000000000000000000;
        const UPSTREAM_MAX_STREAM_DURATION_REACHED  = 0b000000010000000000000000000000;
        const RESPONSE_FROM_CACHE_FILTER            = 0b000000100000000000000000000000;
        const NO_FILTER_CONFIG_FOUND                = 0b000001000000000000000000000000;
        const OVERLOAD_MANAGER_TERMINATED           = 0b000010000000000000000000000000;
        const DNS_RESOLUTION_FAILED                 = 0b000100000000000000000000000000;
        const DROP_OVERLOAD                         = 0b001000000000000000000000000000;
        const DOWNSTREAM_REMOTE_RESET               = 0b010000000000000000000000000000;
        const UNCONDITIONAL_DROP_OVERLOAD           = 0b100000000000000000000000000000;
    }
}
